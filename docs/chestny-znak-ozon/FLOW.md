...
Статус: целевая спецификация; этапы 0 и 1 завершены, этапы 2-13 реализованы
локально и ожидают отдельного production rollout.
...
На 10 августа 2026 года этапы 0 и 1 завершены. Этапы 2-13 реализованы локально и
проверены в изолированной PostgreSQL 17, но миграции, backfill, keyring
credential и импорт реальных КМ еще не развернуты в production. Следующий этап
разработки: этап 14. Реальная detached подпись УКЭП, read-only ГИС МТ,
