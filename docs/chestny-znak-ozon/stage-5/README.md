...
Статус: реализован и проверен локально; production rollout и импорт реальных
КМ не выполнялись.
...
- загрузка реального или тестового production-пула;
...
Следующий этап разработки: физические единицы, assignments и атомарный
JIT-склад.
